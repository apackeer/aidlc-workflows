...
> - **`dist/<harness>/…`** -- an **ignored local generated** source/development projection (`dist/claude/.claude/`, `dist/kiro/.kiro/`, `dist/kiro-ide/.kiro/`, `dist/codex/`, `dist/opencode/`, `dist/copilot/`). Never hand-edited or committed; materialized by `bun scripts/package.ts`. Release payloads use `runtime/<harness>/` inside `aidlc-runtime.tar.gz`.
...
| [Hooks and Tools](06-hooks-and-tools.md) | Hook system, CLI tools, 85-event audit taxonomy |
